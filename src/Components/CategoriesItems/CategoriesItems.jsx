...
export default function CategoriesItems() {
  ...
  return (
    <>
      <h1 className="text-3xl">CategoriesItems</h1>
      <div className="my-4">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              <Link key={categories?._id} className="bg-white p-4 rounded-lg shadow-md">
                <img
    ...
    <div className="flex flex-wrap justify-evenly my-4">
      ...
      return (
        <div
          key={index}
          className="card w-full md:w-1/2 lg:w-1/3 xl:w-1/5 rounded-lg p-2 shadow-md relative"
        >
